...
Page({
  ...
  next(){
    //判断对错
    if(this.data.subject.answer.toString()==this.data.userSelect.sort().toString()){
  ...
  submit(){
    this.data.showGotoMis=true
    this.setData({
      showGotoMis:this.data.showGotoMis
    })
  }
})
